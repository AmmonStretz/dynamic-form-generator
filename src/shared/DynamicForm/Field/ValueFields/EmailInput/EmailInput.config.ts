...
export interface EmailInputSettings extends ValueFieldSettings<string> {
  maxLength?: number
  showLength?: boolean
}

export class EmailInputConfig extends ValueFieldConfig<string> {
  constructor(
    public key: string,
    public settings: EmailInputSettings,
